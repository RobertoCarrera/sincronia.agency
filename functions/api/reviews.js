...
// (NO necesita prefijo PUBLIC_), y el cliente llama a este endpoint del mismo
// dominio (mismo origen, sin CORS, sin restricción de referer).
//
// Env vars requeridas:
//   GOOGLE_PLACES_API_KEY  — API key con HTTP referer restriction (o IP, o None)
...
export async function onRequestGet(context) {
  ...
  if (!KEY || !PLACE) {
    return new Response(
      JSON.stringify({ error: 'GOOGLE_PLACES_API_KEY or GOOGLE_PLACE_ID not configured' }),
