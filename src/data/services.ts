...
export interface ServiceTier extends Tier {
  ...
  offer?:
    | { type: 'free-months'; count: number }
    | { type: 'discount'; percent: number; months: number; discountedPrice: number };
}
...
export const services: ServiceMeta[] = [
  ...
  },
  {
    ...
    priceUnit: 'mes',
    shortDescription: {
      es: 'Hosting WordPress en AWS Lightsail con stack de plugins premium incluido. 30% de descuento los 3 primeros meses, luego desde 45€/mes.',
      ca: 'Hosting WordPress a AWS Lightsail amb stack de plugins premium inclòs. 30% de descompte els 3 primers mesos, després des de 45€/mes.',
      en: 'WordPress hosting on AWS Lightsail with premium plugin stack included. 30% off the first 3 months, then from €45/month.',
    },
    cta: { label: 'Empezar', href: '/contacto' },
    tiers: [
      {
        ...
        offer: { type: 'discount', percent: 30, months: 3, discountedPrice: 31.5 },
        features: [
      ...
      },
      {
        ...
        highlight: true,
        offer: { type: 'discount', percent: 30, months: 3, discountedPrice: 42 },
        features: [
      ...
      },
      {
        ...
        offer: { type: 'discount', percent: 30, months: 3, discountedPrice: 70 },
        features: [
